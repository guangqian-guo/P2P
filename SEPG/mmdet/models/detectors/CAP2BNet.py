...
class CAP2BNet(TwoStageDetector):
    def __init__(self,
                 backbone,
                 roi_head,
                 train_cfg,
    ...
    def forward_train(self,
        ...
        for stage in range(self.num_stages):
            ...
            roi_losses, pseudo_boxes, dynamic_weight, img_dynamic_weight  = self.roi_head.forward_train(stage, x, img_metas,
                                                                                   pseudo_boxes,
                                                                                   generate_proposals,
                                                                                   proposals_valid_list,
