...
class SAM_PRNet(TwoStageDetector):
    def __init__(self,
                 backbone,
                 roi_head,
                 train_cfg,
    ...
    def simple_test(self, img, img_metas, gt_bboxes, gt_anns_id, gt_true_bboxes, gt_labels,
        ...
        for stage in range(self.num_stages):
            ...
            if stage == 0:
                ...
                generate_proposals, proposals_valid_list = fine_proposals_from_cfg(gt_bboxes, fine_proposal_cfg,
