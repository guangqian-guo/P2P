...
model = dict(
    ...
    train_cfg=dict(
        base_proposal=dict(
            base_scales=[4, 8, 16, 32, 64, 128, 256],  # added 256, --ggq
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1000, 240), (1000, 288), (1000, 344), (1000, 432), (1000, 600), (1000, 800)],
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(1000, test_scale) if test_scale else (1333, 800),
        flip=False,
        transforms=[
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + "trainval/cocofmt_annotations/VOC07_trainval_coarse.json",
...
evaluation = dict(
    ...
    save_result_file=save_dir + '_' + str(test_scale) + '_latest_result.json',
