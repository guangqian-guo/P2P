...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            type='MSEMILHeadv7',  #Shared2FCInstanceHierMILHead
            num_stages=num_stages,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        # ann_file=data_root + "annotations/instances_train2017_coarse_proposal.json",
        ann_file=data_root + "trainval/cocofmt_annotations/VOC07_trainval_coarse_proposals_adjust_centers.json",
        img_prefix=data_root + 'trainval/JPEGImages/',  # 'train2017/',
...
# optimizer
optimizer = dict(type='SGD', lr=0.01, momentum=0.9, weight_decay=0.0001)  #batch = 8 --> lr = 0.01
...
evaluation = dict(
    ...
    # save_result_file='work-dir/COCO/SAM_PRNetv7_Headv11_MSEv7_lr0.02_thr0.5/' + '_1200_latest_result.json',
    save_result_file='work-dir/COCO/SAM_PRNetv7_Headv11_MSEv7_lr0.02/' + '_1200_1epoch_result.json',
