'''
command:
python exp/tools/adjust_center_point_for_hard_cases.py  --pse-gt-path ../../segment-anything-main/proposals_with_maskv2/results_with_iou_lower_0.5_inslevel.json --gt-path data/COCO/annotations/instances_train2017_coarse.json  --save-dir ../../segment-anything-main/proposals_with_maskv2/ 
'''
...
def main(args):
    ...
    with open(save_dir+pse_gt_path.split('.')[0]+'_adjust_centers.json', 'w') as f:
