    ...
    for img_id in tqdm(pse_gt.getImgIds()[:num]):
        ...
        for pse_ann in pse_anns:
            ...
            img = cv2.rectangle(img, tuple(top_left), tuple(bottom_right), (255,80, 0),
                                5)  # blue(0,229,238) yellow(255,215,0) green(127,255,0) orange(255,140,0) red (255, 80 ,0)
            ...
            ax.text(
                ...
                color= (127/255,1,0), #(1,80/255,0), #(127/255,1,0),
                fontsize=8,
        ...
        # 保存图片
        plt.imshow(img)
        # pse_gt.showAnns(pse_anns, draw_bbox=False)   # show segmentation
        # plt.show()
